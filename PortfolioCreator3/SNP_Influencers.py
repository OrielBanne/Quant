...
import pandas as pd
from utils import log_momentum_summary
            ...
            if analysis and analysis['missing_influencers']:
                ...
                for stock in top_missing:
                    try:
                        ...
                        # Check momentum if algorithm is provided
                        if algorithm is not None:
                            # Import momentum check function
                            from utils import check_positive_momentum, calculate_williams_alligator_momentum
                            
                            # Get momentum score
                            momentum_score = calculate_williams_alligator_momentum(algorithm, symbol, 30)
                            has_positive_momentum = momentum_score > 50  # Now that calculation is fixed
